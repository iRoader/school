 ...
 */
(function (angular) {
    angular.module('student.requestSvc', ['ngResource'])
        ...
        .factory('message', ['requestHelper', function(requestHelper){
            var _baseUrl = '/api/student/:student_id/messages/';

            return {
                get: function(id){
                    return requestHelper.get(_baseUrl, {student_id:id},{});
                }
            }
        }])
        ...
        .factory('classes', ['requestHelper', function(requestHelper){
            var _baseUrl = '/api/student/:student_id/classes/';
                _baseUrl2 = '/student/create/term/';
        ...
        .factory('student_grade', ['requestHelper', function(requestHelper){
            var _baseUrl = '/api/student/class/:school_class_id/students/';
                _baseUrl2 = '/student/handle/grade/'
            return {
                get: function(id){
                    return requestHelper.get(_baseUrl, {school_class_id:id},{});
                },
        ...
        .factory('term', ['requestHelper', function(requestHelper){
            var _baseUrl = '/api/student/:student_id/terms/';
        ...
        .factory('class_term', ['requestHelper', function(requestHelper){
            var _baseUrl = 'http://192.168.101.100:8888/api/student/class/:school_class_id/terms/';
        ...
        .factory('record', ['requestHelper', function(requestHelper){
            var _baseUrl = '/student/handle/grade/';
        ...
        .factory('jump', ['requestHelper', function(requestHelper){
            var _baseUrl = '/student/record/grade/';
